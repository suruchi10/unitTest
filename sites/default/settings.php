...
$config_directories['sync'] = 'sites/default/files/config_acqTmp-2017-07-27T11.09.41-1946/sync';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupalHope_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupalHope_dd.inc';
}
// </DDSETTINGS>
